...
const tasks: Task[] = [
    ...
    {
        image: "/images/tasks/task_invite.png",  
    ...
    {
        image: "/images/tasks/task_transaction.png",  
    ...
    {
        image: "/images/tasks/task_game.png",  
...
const TaskCard = ({ task }: { task: Task }) => {
    return (
        <div className="flex flex-col bg-gray-600/50 rounded-lg p-4 shadow-md w-full mt-20">
